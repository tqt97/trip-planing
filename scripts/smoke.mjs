...
for (const file of ['src/app/radar-view.js','src/app/storage.js','src/app/ui.js','src/data/supabase-client.js','src/data/repository.js','supabase/RESET_ALL.sql','supabase/migrations/001_v2_collaboration.sql','data/default-places.json','api/route.js','api/matrix.js','api/config.js']) {
...
if (main.split('\n').length > 360) throw new Error('Smoke failed: src/app/main.js orchestration file too large after refactor');
