...
const files = [
  ...
  'src/app/ui.js','src/app/radar-view.js','src/features/places/place-view.js','src/features/recommendations/recommendation-view.js','src/features/expenses/expense-view.js'
];
const size = file => fs.statSync(file).size;
const gzip = file => zlib.gzipSync(fs.readFileSync(file), { level: 9 }).length;
const budgets = { 'styles.css': 34000, 'src/app/main.js': 36000, 'src/core.js': 22000, 'src/data/supabase-client.js': 12000 };
