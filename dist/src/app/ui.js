...
export function collectElements() {
  return {
    ...
    expenseList: $('#expenseList'), expenseTotal: $('#expenseTotal'), expenseCount: $('#expenseCount'), expenseEmpty: $('#expenseEmpty'), expenseDialog: $('#expenseDialog'), expenseForm: $('#expenseForm'), expenseId: $('#expenseId'), expensePayer: $('#expensePayer'), expenseCategory: $('#expenseCategory'), expenseAmount: $('#expenseAmount'), expenseNote: $('#expenseNote'), expenseMessage: $('#expenseMessage'), expenseDialogTitle: $('#expenseDialogTitle'), saveExpenseBtn: $('#saveExpenseBtn'), backToTop: $('#backToTop'),
    ...
    placeDialog: $('#placeDialog'), placeForm: $('#placeForm'), placeId: $('#placeId'), placeName: $('#placeName'), placeAddress: $('#placeAddress'), placeMapsUrl: $('#placeMapsUrl'), placeCategory: $('#placeCategory'), placePriority: $('#placePriority'), placeNote: $('#placeNote'), placeLat: $('#placeLat'), placeLng: $('#placeLng'), placeMessage: $('#placeMessage'), placeDialogTitle: $('#placeDialogTitle'), savePlaceBtn: $('#savePlaceBtn'),
    ...
    traceDialog: $('#traceDialog'), traceList: $('#traceList'), systemHealth: $('#systemHealth')
  };
}
