...
export function collectElements() {
  return {
    ...
    albumList: $('#albumList'), albumEmpty: $('#albumEmpty'), albumCount: $('#albumCount'), albumVisibleCount: $('#albumVisibleCount'), albumFilter: $('#albumFilter'), albumDialog: $('#albumDialog'), albumForm: $('#albumForm'), albumId: $('#albumId'), albumTitle: $('#albumTitle'), albumStatus: $('#albumStatus'), albumNote: $('#albumNote'), albumNoteUrl: $('#albumNoteUrl'), albumImage: $('#albumImage'), albumMessage: $('#albumMessage'), albumDialogTitle: $('#albumDialogTitle'), saveAlbumBtn: $('#saveAlbumBtn'), albumLightbox: $('#albumLightbox'), albumLightboxImage: $('#albumLightboxImage'), albumLightboxPlaceholder: $('#albumLightboxPlaceholder'), albumLightboxTitle: $('#albumLightboxTitle'), albumLightboxStatus: $('#albumLightboxStatus'), albumLightboxNote: $('#albumLightboxNote'), albumLightboxLink: $('#albumLightboxLink'),
