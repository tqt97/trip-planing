...
export function collectElements() {
  return {
    ...
    expenseList: $('#expenseList'), settlementList: $('#settlementList'), expenseTotal: $('#expenseTotal'), expenseCount: $('#expenseCount'), expenseAverage: $('#expenseAverage'), peopleCount: $('#peopleCount'), expenseEmpty: $('#expenseEmpty'), expenseDialog: $('#expenseDialog'), expenseForm: $('#expenseForm'), expenseId: $('#expenseId'), expensePayer: $('#expensePayer'), expenseCategory: $('#expenseCategory'), expenseAmount: $('#expenseAmount'), expenseNote: $('#expenseNote'), expenseParticipants: $('#expenseParticipants'), expenseMessage: $('#expenseMessage'), expenseDialogTitle: $('#expenseDialogTitle'), saveExpenseBtn: $('#saveExpenseBtn'), expensePagination: $('#expensePagination'), expensePageNumbers: $('#expensePageNumbers'), expensePageSummary: $('#expensePageSummary'), expensePrevPageBtn: $('#expensePrevPageBtn'), expenseNextPageBtn: $('#expenseNextPageBtn'), backToTop: $('#backToTop'),
    ...
    timelineList: $('#timelineList'), timelineEmpty: $('#timelineEmpty'), timelineCount: $('#timelineCount'), timelineDialog: $('#timelineDialog'), timelineForm: $('#timelineForm'), timelineId: $('#timelineId'), timelineDate: $('#timelineDate'), timelineTime: $('#timelineTime'), timelineTitle: $('#timelineTitle'), timelinePlace: $('#timelinePlace'), timelineNote: $('#timelineNote'), timelineMessage: $('#timelineMessage'), timelineDialogTitle: $('#timelineDialogTitle'), saveTimelineBtn: $('#saveTimelineBtn'), checklistList: $('#checklistList'), checklistEmpty: $('#checklistEmpty'), checklistDialog: $('#checklistDialog'), checklistForm: $('#checklistForm'), checklistId: $('#checklistId'), checklistTitle: $('#checklistTitle'), checklistCategory: $('#checklistCategory'), checklistVisibility: $('#checklistVisibility'), checklistNote: $('#checklistNote'), checklistMessage: $('#checklistMessage'), checklistDialogTitle: $('#checklistDialogTitle'), saveChecklistBtn: $('#saveChecklistBtn'), checklistCount: $('#checklistCount'), checklistDoneCount: $('#checklistDoneCount'), traceDialog: $('#traceDialog'), traceList: $('#traceList'), systemHealth: $('#systemHealth')
  };
}
